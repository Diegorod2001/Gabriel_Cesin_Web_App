...
<body>
    ...
    <section id="visual-producto">
        
        <div class="container">
            <div class="img-container"></div>
            <div class="texto">
                <h2>Camisa H&M Por tan solo 18$</h2>
                <p>Descripción: Camisa de color negro para Hombre de H&M talla S y M disponible  </p>
    ...
    <section id= "formulario-compra">
        ...
        <div id="wrapper">
            ...
            <form action="https://formsubmit.co/gabrielcesin08@gmail.com" method="POST">
                ...
                <input type="text" class="form-control mb-3"  name="cantidad-talla" placeholder= "Disponible talla S (4) y M (1)">
    ...
    <section id="whatsapp">
        <a href="https://wa.me/5804123968146?text= Necesito Información de la camisa para caballero de HYM" target="_blank"> <img src="img/whatsapp-fill.svg" style="width: 80px; height: 80px;  "></a>
        <br><br>
    </section>
