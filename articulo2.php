...
<body>
    ...
    <section id="visual-blusa">
        
        <div class="container">
            <div class="img-container"></div>
            <div class="texto">
                <h2>Blusa ZARA Por tan solo 18$</h2>
                <p>Descripción: Blusa Elegante de ZARA Disponible en talla S y M. <br> Hacemos envio en toda Venezuela  </p>
    ...
    <section id= "formulario-compra">
        ...
        <div id="wrapper">
            ...
            <form action="https://formsubmit.co/gabrielcesin08@gmail.com" method="POST">
                ...
                <input type="text" class="form-control mb-3"  name="cantidad-talla" placeholder= "Disponible talla S (10) y M (8)">
    ...
    <section id="whatsapp">
        <a href="https://wa.me/5804123968146?text= Necesito Información de la Blusa de ZARA Por Favor" target="_blank"> <img src="img/whatsapp-fill.svg" style="width: 80px; height: 80px;  "></a>
        <br><br>
    </section>
